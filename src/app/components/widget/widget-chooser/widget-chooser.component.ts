...
import{ActiveetedRoute,Router} from "@angular/router";
...
wid: string;
pid: string;
  constructor(private acritivatedRoute:ActivatedRoute private widgetService: WidgetService,private router:Router) { }
